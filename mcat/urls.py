...
from mcat.views import ProductView, CategoryHomeView, CategoryView, ProductsInCategoryView, SearchView, add_to_cart
...
urlpatterns = patterns('',
    ...
    url(r'^cart/add/(?P<slug>[-_\w]+)/$', add_to_cart, name="product-add-to-cart"),
